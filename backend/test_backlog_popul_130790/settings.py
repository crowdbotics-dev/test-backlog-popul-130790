"""
Django settings for test_backlog_popul_130790 project.
...
ROOT_URLCONF = 'test_backlog_popul_130790.urls'
...
WSGI_APPLICATION = 'test_backlog_popul_130790.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_backlog_popul_130790 API",
    "DESCRIPTION": "API documentation for test_backlog_popul_130790 App",
    "VERSION": "v1",
}
